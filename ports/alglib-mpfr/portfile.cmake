...
#git diff > ..\..\..\..\ports\alglib-mpfr\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\alglib-mpfr\001_alglib-mpfr_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.alglib.net/translator/re/alglib-2.6.0.mpfr.zip"
    FILENAME "alglib-2.6.0.mpfr.zip"
    SHA512 d8e6b73c65488adee92b3f731bd9e7dbfd26f0d2643a8b6170788ff1ac1333156cf53b72cd71c9fb165e0c1f61dc70d946386045ace2cae3a6f9ceb766fdc1d3
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_alglib-mpfr_fixes.patch
#      001_alglib-mpfr_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.alglib.net/translator/re/alglib-2.6.0.mpfr.zip")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/alglib-mpfr RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME alglib-mpfr)
