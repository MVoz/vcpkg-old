...
#git diff > ..\..\..\..\ports\avi20\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\avi20\001_avi20_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/TechSmith/AVI20/archive/475cf062fb9818100595133c471b5b65c709c665.zip"
    FILENAME "475cf062fb9818100595133c471b5b65c709c665.zip"
    SHA512 b9c3604c87376e379a94ec8825f0d6dbb71c1ac11ced756383f974f8ebbeaa68502b2dfb44c3a0abec5600ca65714fa5a07edf5ccf04452fd46a675e03f50f6d
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_avi20_fixes.patch
#      001_avi20_patch.patch
)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
#    PROJECT_SUBPATH "avi20.vcxproj"
#	TARGET restore
	SKIP_CLEAN
#	LICENSE_SUBPATH LICENSE
	LICENSE_SUBPATH README.md
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/avi20 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME avi20)
