...
#git diff > ..\..\..\..\ports\broadvoice\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\broadvoice\001_broadvoice_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://files.freeswitch.org/downloads/libs/broadvoice-0.1.0.tar.gz"
    FILENAME "broadvoice-0.1.0.tar.gz"
    SHA512 12bb5f80a1fa68ea85db561dda14c9d3544b473f7ff365fb4974e937a57e79f202e42643f3b7f099a4a5f74b7d650e5b75390e3895502821ba9b0b1ec9b28d9b
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_broadvoice_fixes.patch
#      001_broadvoice_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://files.freeswitch.org/downloads/libs/broadvoice-0.1.0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/broadvoice RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME broadvoice)
