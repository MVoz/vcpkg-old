...
set(GIT_URL "https://bitbucket.org/chromiumembedded/cef")
set(GIT_REV master)
...
set(ENV{PATH} ";$ENV{PATH};E:/tools/vcpkg/downloads/tools/depot_tools;${PYTHON2_DIR};")

vcpkg_execute_required_process(
    COMMAND ${PYTHON2} tools/gclient_hook.py
    WORKING_DIRECTORY ${SOURCE_PATH}
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/cef RENAME copyright)
