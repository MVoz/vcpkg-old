...
#git diff > ..\..\..\..\ports\celt\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\celt\001_celt_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/celt-0.10.0.tar.gz"
    FILENAME "celt-0.10.0.tar.gz"
    SHA512 1d36839722ec6498aaaa941f7929f9b4f39bd2feba02017acd83d106973dff71ed2ea6cd99d2dbf1c9c2f03843d4b057b068e25874f4a8f7b7c26a2735cf9ff8
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_celt_fixes.patch
#      001_celt_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/celt-0.10.0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/celt RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME celt)
