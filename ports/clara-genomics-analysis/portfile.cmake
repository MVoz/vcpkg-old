...
#git diff > ..\..\..\..\ports\clara-genomics-analysis\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\clara-genomics-analysis\001_clara-genomics-analysis_patch.patch
...
set(GIT_URL "https://github.com/clara-genomics/ClaraGenomicsAnalysis")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/clara-genomics-analysis RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME clara-genomics-analysis)
