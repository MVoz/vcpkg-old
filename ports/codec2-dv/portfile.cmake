...
#git diff > ..\..\..\..\ports\codec2-dv\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\codec2-dv\001_codec2-dv_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://hobbes1069.fedorapeople.org/freetel/codec2/codec2-0.8.1.tar.xz"
    FILENAME "codec2-0.8.1.tar.xz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_codec2-dv_fixes.patch
#      001_codec2-dv_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/codec2-dv RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME codec2-dv)
