...
vcpkg_download_distfile(ARCHIVE
    URLS "https://bitbucket.org/Coin3D/coin/get/default.tar.bz2"
    FILENAME "default.tar.bz2"
    SHA512 6dc16db86ac43598867ac312a91f279b75a625d9b22ce76cec5af6c957e0bf7e7a9e46125b331fafe1a2c5fb58a6cac6a715e99d8bd973a5483ec027b74876b7
)
...
#	CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_CFG_INTDIR=${CMAKE_CFG_INTDIR} -DCMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX} -DCMAKE_PREFIX_PATH=${CMAKE_PREFIX_PATH} -DCMAKE_TRY_COMPILE_CONFIGURATION=${CMAKE_TRY_COMPILE_CONFIGURATION} -DCOIN_BUILD_DOCUMENTATION=OFF -DCOIN_BUILD_TESTS=OFF
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/coin3d-coin RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME coin3d-coin)
