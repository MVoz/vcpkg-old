...
set(GIT_URL "https://github.com/cudpp/cudpp")
set(GIT_REV master)
...
vcpkg_configure_cmake(
    ...
    OPTIONS 
      ...
      -DCUDA_VERBOSE_PTXAS:BOOL=ON
      -DCUDPP_BUILD_APPLICATIONS:BOOL=ON
      -DCUDPP_BUILD_SHARED_LIBS:BOOL=ON
      -DCUDPP_GENCODE_SM30:BOOL=ON
      -DCUDPP_GENCODE_SM35:BOOL=ON
      -DCUDPP_GENCODE_SM50:BOOL=ON
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/cudpp RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME cudpp)
