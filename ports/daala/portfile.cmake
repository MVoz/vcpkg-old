...
#git diff > ..\..\..\..\ports\daala\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\daala\001_daala_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/xiph/daala/archive/d10a875282e69c56fec3a3584bf06709e00edabe.zip"
    FILENAME "d10a875282e69c56fec3a3584bf06709e00edabe.zip"
    SHA512 3db8deacae501f23583b389057374348df81c597baec2ef921168211ec29c8e09ca03d965d8c05ae2d0ef7c52f65600c9b222e1cc308020dd300ff61b203b334
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_daala_fixes.patch
#      001_daala_patch.patch
)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "win32/Visual Studio/VS2010/Daala_static.sln"
	SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/daala RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME daala)
