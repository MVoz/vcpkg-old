...
#git diff > ..\..\..\..\ports\dalton\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\dalton\001_dalton_patch.patch
...
set(GIT_URL "https://gitlab.com/dalton/dalton")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/dalton RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME dalton)
