...
#git diff > ..\..\..\..\ports\dataseltzer\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\dataseltzer\001_dataseltzer_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.gaia-gis.it/gaia-sins/dataseltzer-1.0.0.tar.gz"
    FILENAME "dataseltzer-1.0.0.tar.gz"
    SHA512 4ad89d1ce8fae24bc8a08af30a95985515f701e2cf2a459290af220493d5ee5abf93dde07db6c5b8fce9861218546d90c708f3daba96735410662d169b209f1b
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_dataseltzer_fixes.patch
#      001_dataseltzer_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.gaia-gis.it/gaia-sins/dataseltzer-1.0.0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/dataseltzer RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME dataseltzer)
