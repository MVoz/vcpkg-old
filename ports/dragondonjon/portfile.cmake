...
#git diff > ..\..\..\..\ports\dragondonjon\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\dragondonjon\001_dragondonjon_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.polymtl.ca/merlin/downloads/version5_v5.0.5.tgz"
    FILENAME "version5_v5.0.5.tgz"
    SHA512 b891e4b686b8e8a29b192f1f0ea0be58a181959de34c90734314a8bceb167a180d7199d5da2681476433b408a9cc96a64444d3dd57532753e11bad24225628d8
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_dragondonjon_fixes.patch
#      001_dragondonjon_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.polymtl.ca/merlin/downloads/version5_v5.0.5.tgz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/dragondonjon RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME dragondonjon)
