...
#git diff > ..\..\..\..\ports\fastbit\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\fastbit\001_fastbit_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://visit.ilight.com/svn/visit/trunk/third_party/fastbit-2.0.3.tar.gz"
    FILENAME "fastbit-2.0.3.tar.gz"
    SHA512 ea795391e57463700e97d0c05a8137ef91237342c24993a003cadde612318c0f66c37178ea13fe4d5aeb150ab62e9f0df3024a78fe96adbd14e7de3e5de378e0
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_fastbit_fixes.patch
#      001_fastbit_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://visit.ilight.com/svn/visit/trunk/third_party/fastbit-2.0.3.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/fastbit RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME fastbit)
