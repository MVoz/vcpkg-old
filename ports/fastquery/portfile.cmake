...
#git diff > ..\..\..\..\ports\fastquery\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\fastquery\001_fastquery_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://visit.ilight.com/svn/visit/trunk/third_party/fastquery-0.8.4.3.tar.gz"
    FILENAME "fastquery-0.8.4.3.tar.gz"
    SHA512 e547dc31b0771a57d2acc7e966ee56ad6a6e7d6ecb000e2fbafa1ad65436cb093ac16140937ee4cd7154006ab26a1d478728005eedad9dc9fd6908d49c1645c0
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_fastquery_fixes.patch
#      001_fastquery_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://visit.ilight.com/svn/visit/trunk/third_party/fastquery-0.8.4.3.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/fastquery RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME fastquery)
