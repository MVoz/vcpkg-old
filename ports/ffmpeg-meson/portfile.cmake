...
set(GIT_URL "https://gitlab.freedesktop.org/gstreamer/meson-ports/ffmpeg")
set(GIT_REV meson-4.1)
...
set(ENV{PATH} "$ENV{PATH};${YASM_EXE_PATH};${PYTHON3_DIR};${NASM_EXE_PATH};${SH_EXE_PATH}")
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ffmpeg-meson RENAME copyright)
