...
set(OPTIONS "${OPTIONS} --extra-cflags=-DHAVE_WINSOCK2_H=1 --extra-cflags=-DHAVE_WINSOCK_H=0 --extra-cflags=-DHAVE_WINDOWS_H=1 --extra-cflags=-DHAVE_UNISTD_H=0 --extra-cflags=-DHAVE_ARPA_INET_H=0 --extra-cflags=-DHAVE_FCNTL=1 --extra-cflags=-I${CURRENT_INSTALLED_DIR}/include")
