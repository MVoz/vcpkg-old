...
set(GIT_URL "https://bitbucket.org/acoustid/acoustid-fingerprinter.git")
set(GIT_REV master)
...
vcpkg_find_acquire_program(QT4)
...
get_filename_component(QT_DIR "${QT4}" DIRECTORY)
set(ENV{QT_QMAKE_EXECUTABLE} ${QT4})
...
#    DISABLE_PARALLEL_CONFIGURE
    OPTIONS_DEBUG # automatic templates
		...
		-DTAGLIB_LIBRARIES=${CURRENT_INSTALLED_DIR}/debug/lib/tag.lib
		-DTAGLIB_INCLUDES=${CURRENT_INSTALLED_DIR}/include/taglib
		-DCMAKE_IGNORE_PATH=${CURRENT_INSTALLED_DIR}/tools/qt5
    OPTIONS_RELEASE
        -DCMAKE_IGNORE_PATH=${CURRENT_INSTALLED_DIR}/tools/qt5
    OPTIONS 
        -DBUILD_SHARED_LIBS=ON # automatic templates
		-DTAGLIB_LIBRARIES=${CURRENT_INSTALLED_DIR}/lib/tag.lib
		-DTAGLIB_INCLUDES=${CURRENT_INSTALLED_DIR}/include/taglib
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/fingerprinter RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME fingerprinter)
