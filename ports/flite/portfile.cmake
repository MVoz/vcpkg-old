...
#git diff > ..\..\..\..\ports\flite\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\flite\001_flite_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/flite-2.0.0.tar.gz"
    FILENAME "flite-2.0.0.tar.gz"
    SHA512 cca6631c48595804f957d1fe6223a814d6dbf092cbe73aca85146921aba73a62bfc62eca12245f62667932a853124a534d545edd4d7a49f8a72e82229ee1d8cf
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_flite_fixes.patch
#      001_flite_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/flite-2.0.0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/flite RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME flite)
