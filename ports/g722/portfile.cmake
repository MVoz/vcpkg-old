...
#git diff > ..\..\..\..\ports\g722\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\g722\001_g722_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/g722_1-0.2.0.tar.gz"
    FILENAME "g722_1-0.2.0.tar.gz"
    SHA512 44705c9135e66199936b2e7d03be5e878f4d39eb872a2f5e08904a6fe109f50f6659ca365f896d27ed54e4886a5fea7dd5300f325c4d2f035911304855679a76
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_g722_fixes.patch
#      001_g722_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/g722_1-0.2.0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/g722 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME g722)
