...
set(GIT_URL "https://github.com/goldendict/goldendict")
set(GIT_REV master)
...
get_filename_component(QT4_DIR "${QT4}" DIRECTORY)
set(ENV{PATH} "$ENV{PATH};${GIT_DIR};${QT4_DIR}")

find_program(QMAKE_EXECUTABLE NAMES qmake HINTS "${QT4}/../bin")
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH goldendict.vcxproj
#	TARGET restore
	SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/goldendict RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME goldendict)
