...
#git diff > ..\..\..\..\ports\gromacs\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\gromacs\001_gromacs_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://ftp.gromacs.org/pub/gromacs/gromacs-2019.3.tar.gz"
    FILENAME "gromacs-2019.3.tar.gz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_gromacs_fixes.patch
#      001_gromacs_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/gromacs RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME gromacs)
