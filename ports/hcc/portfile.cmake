...
#git diff > ..\..\..\..\ports\hcc\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\hcc\001_hcc_patch.patch
...
set(GIT_URL "https://github.com/RadeonOpenCompute/hcc")
set(GIT_REV master)
...
set(ENV{PATH} "$ENV{PATH};${CLANG_DIR};${LLVM_DIR}")
...
#      -D =OFF
    OPTIONS 
	  -DOPENCL_HEADER_DIR=${CURRENT_INSTALLED_DIR}/include/CL
	  
#	  -DHSA_HEADER_DIR=<path_to_hsa.h>.
#	  -DHSA_LIBRARY_DIR=<path_to_libhsa-runtime64.so>.
#	  -DHSA_HOF_DIR=<path_to_hof>.
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/hcc RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME hcc)
