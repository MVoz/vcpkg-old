...
#git diff > ..\..\..\..\ports\hip\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\hip\001_hip_patch.patch
...
set(GIT_URL "https://github.com/ROCm-Developer-Tools/HIP")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/hip RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME hip)
