...
#git diff > ..\..\..\..\ports\ign-tools2\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ign-tools2\001_ign-tools2_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://bitbucket.org/ignitionrobotics/ign-fuel-tools/get/ignition-fuel-tools2_2.0.0.zip"
    FILENAME "ignition-fuel-tools2_2.0.0.zip"
    SHA512 0619d7d49a4db933707de83a0191ef37096f2195d0a950092a2016d982cd1dcb23d79352c67527908cae073e88dbedab9d3c12d8a0ef7aa6b235066c1726a63b
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_ign-tools2_fixes.patch
#      001_ign-tools2_patch.patch
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ign-tools2 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ign-tools2)
