...
#git diff > ..\..\..\..\ports\ilbc\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\ilbc\001_ilbc_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/ilbc-0.0.1.tar.gz"
    FILENAME "ilbc-0.0.1.tar.gz"
    SHA512 35ab51c5fe7cc4e820375bd9d991168119ecf0160024da0ad7191f27b4827e3958471724238e4bc940435c1fc9e33b2c82bb6d20943c00599f297039669ce237
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_ilbc_fixes.patch
#      001_ilbc_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/ilbc-0.0.1.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ilbc RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME ilbc)
