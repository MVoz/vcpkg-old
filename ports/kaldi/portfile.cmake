...
set(GIT_URL "https://github.com/kaldi-asr/kaldi")
set(GIT_REV master)
...
vcpkg_configure_cmake(
    ...
    OPTIONS 
      -DOPENFST_INCLUDE_DIRS=${CURRENT_INSTALLED_DIR}/include
	  -DOPENFST_BIN_DIRS=${CURRENT_INSTALLED_DIR}/bin
	  -DOPENFST_INCLUDE_DIRECTORIES=${CURRENT_INSTALLED_DIR}/include
	  
	  -DOPENFST_INCLUDE_DIR:PATH=${CURRENT_INSTALLED_DIR}/include/fst
	  -DOPENFST_LIB:FILEPATH=${CURRENT_INSTALLED_DIR}/lib/fst.lib
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/kaldi RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME kaldi)
