...
set(GIT_URL "https://github.com/monero-project/kovri")
set(GIT_REV master)
...
#LINK : fatal error LNK1104: cannot open file 'boost_date_time-vc141-mt-gd-x64-1_70.lib'
...
vcpkg_configure_cmake(
    ...
    OPTIONS 
      ...
      -DWITH_CRYPTOPP=OFF
      -DWITH_DOXYGEN=OFF
      -DWITH_FUZZ_TESTS=OFF
      -DWITH_HARDENING=OFF
      -DWITH_KOVRI_UTIL=OFF
      -DWITH_OPTIMIZE=OFF
      -DWITH_PYTHON=OFF
      -DWITH_SHARED_DEPS=ON
      -DWITH_STATIC=OFF
      -DWITH_STATIC_DEPS=OFF
      -DWITH_TESTS=OFF
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/kovri RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME kovri)
