...
#git diff > ..\..\..\..\ports\lbann\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\lbann\001_lbann_patch.patch
...
set(GIT_URL "https://github.com/LLNL/lbann")
set(GIT_REV develop)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/lbann RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME lbann)
