...
#git diff > ..\..\..\..\ports\libcutl\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libcutl\001_libcutl_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://www.codesynthesis.com/download/libcutl/1.10/libcutl-1.10.0.tar.gz"
    FILENAME "libcutl-1.10.0.tar.gz"
    SHA512 66b99676cc06b268739fe3c697bfc3efbd457489e5451911a98adfc23b2184d0f7e5d4a44c97188dc9700a5cd90b61676f6b7f065aa544e5e59390501366955e
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libcutl_fixes.patch
#      001_libcutl_patch.patch
)
...
vcpkg_install_msbuild(
    ...
    PROJECT_SUBPATH "libcutl-vc10.sln"
#    TARGET restore
    SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libcutl RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libcutl)
