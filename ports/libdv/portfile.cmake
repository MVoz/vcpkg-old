...
#git diff > ..\..\..\..\ports\libdv\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libdv\001_libdv_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://sourceforge.net/projects/libdv/files/libdv/1.0.0/libdv-1.0.0.tar.gz/download"
    FILENAME "download"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libdv_fixes.patch
#      001_libdv_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://sourceforge.net/projects/libdv/files/libdv/1.0.0/libdv-1.0.0.tar.gz/download")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libdv RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libdv)
