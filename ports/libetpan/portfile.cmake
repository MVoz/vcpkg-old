...
#git diff > ..\..\..\..\ports\libetpan\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libetpan\001_libetpan_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/libetpan-0.48.tar.gz"
    FILENAME "libetpan-0.48.tar.gz"
    SHA512 badfccb85ab9e130d7179729e4e7065cf2c5b9089c624639ed045ef7e0f064b842fafa3a0212a9cd86de474f1330ac55dfcabb48cfc133a501bf1ac8a934771e
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libetpan_fixes.patch
#      001_libetpan_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/libetpan-0.48.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libetpan RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libetpan)
