...
#git diff > ..\..\..\..\ports\libid3tag\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libid3tag\001_libid3tag_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://sourceforge.net/projects/mad/files/libid3tag/0.15.1b/libid3tag-0.15.1b.tar.gz/download"
    FILENAME "download"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libid3tag_fixes.patch
#      001_libid3tag_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://sourceforge.net/projects/mad/files/libid3tag/0.15.1b/libid3tag-0.15.1b.tar.gz/download")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libid3tag RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libid3tag)
