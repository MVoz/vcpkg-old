...
#git diff > ..\..\..\..\ports\libmpeg2\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libmpeg2\001_libmpeg2_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/mwgoldsmith/mpeg2/archive/1f6b564c738443b3d3cef350e8a9f2b0719aa1fd.zip"
    FILENAME "1f6b564c738443b3d3cef350e8a9f2b0719aa1fd.zip"
    SHA512 0b5854e61e5fe14b5c33d0d181d409419bc736c6e515669e904db13fac0fc6a3d428b23e394ee747c8f8a09165129cfa8abdcddae57a2c849d9fc09f4fc27ebc
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libmpeg2_fixes.patch
#      001_libmpeg2_patch.patch
)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "projects/vs14/mpeg2.sln"
#	TARGET restore
	SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libmpeg2 RENAME copyright)
