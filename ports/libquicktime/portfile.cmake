...
#git diff > ..\..\..\..\ports\libquicktime\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libquicktime\001_libquicktime_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://sourceforge.net/projects/libquicktime/files/libquicktime/1.2.4/libquicktime-1.2.4.tar.gz/download"
    FILENAME "download"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libquicktime_fixes.patch
#      001_libquicktime_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://sourceforge.net/projects/libquicktime/files/libquicktime/1.2.4/libquicktime-1.2.4.tar.gz/download")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libquicktime RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libquicktime)
