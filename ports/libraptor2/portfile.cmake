...
vcpkg_download_distfile(ARCHIVE
    URLS "http://download.librdf.org/source/raptor2-2.0.15.tar.gz"
    FILENAME "raptor2-2.0.15.tar.gz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libraptor2_fixes.patch
#      001_libraptor2_patch.patch
)
...
vcpkg_configure_cmake(
    ...
    OPTIONS 
#      -DJING:FILEPATH=JING-NOTFOUND
      -DRAPTOR_PARSER_GRDDL:BOOL=TRUE
      -DRAPTOR_PARSER_GUESS:BOOL=TRUE
#      -DRAPTOR_PARSER_JSON:BOOL=
      -DRAPTOR_PARSER_NQUADS:BOOL=TRUE
      -DRAPTOR_PARSER_NTRIPLES:BOOL=TRUE
      -DRAPTOR_PARSER_RDFA:BOOL=TRUE
      -DRAPTOR_PARSER_RDFXML:BOOL=TRUE
      -DRAPTOR_PARSER_RSS:BOOL=TRUE
      -DRAPTOR_PARSER_TRIG:BOOL=TRUE
      -DRAPTOR_PARSER_TURTLE:BOOL=TRUE
      -DRAPTOR_SERIALIZER_ATOM:BOOL=TRUE
      -DRAPTOR_SERIALIZER_DOT:BOOL=TRUE
      -DRAPTOR_SERIALIZER_HTML:BOOL=TRUE
      -DRAPTOR_SERIALIZER_JSON:BOOL=TRUE
      -DRAPTOR_SERIALIZER_NQUADS:BOOL=TRUE
      -DRAPTOR_SERIALIZER_NTRIPLES:BOOL=TRUE
      -DRAPTOR_SERIALIZER_RDFXML:BOOL=TRUE
      -DRAPTOR_SERIALIZER_RDFXML_ABBREV:BOOL=TRUE
      -DRAPTOR_SERIALIZER_RSS_1_0:BOOL=TRUE
      -DRAPTOR_SERIALIZER_TURTLE:BOOL=TRUE
      -DRAPTOR_WWW:STRING=curl
      -DRAPTOR_XML:STRING=libxml
      -DRAPTOR_XML_1_1:BOOL=FALSE
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libraptor2 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libraptor2)
