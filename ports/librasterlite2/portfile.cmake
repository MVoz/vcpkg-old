...
#git diff > ..\..\..\..\ports\librasterlite2\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\librasterlite2\001_librasterlite2_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.gaia-gis.it/gaia-sins/librasterlite2-sources/librasterlite2-1.1.0-beta0.tar.gz"
    FILENAME "librasterlite2-1.1.0-beta0.tar.gz"
    SHA512 2514a781fab3b93740d2f8d8500ae0664be86603e483a4ca576a09da55edc085c5715caa3fcfa686d0590d1c2132957de49b35356624229f66e11ce4ce637e22
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_librasterlite2_fixes.patch
#      001_librasterlite2_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.gaia-gis.it/gaia-sins/librasterlite2-sources/librasterlite2-1.1.0-beta0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/librasterlite2 RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME librasterlite2)
