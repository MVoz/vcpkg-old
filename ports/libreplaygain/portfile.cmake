...
#git diff > ..\..\..\..\ports\libreplaygain\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libreplaygain\001_libreplaygain_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/evpobr/libreplaygain/archive/6eccf00b3e2a8c928e9a4e896c3a211199444e96.zip"
    FILENAME "6eccf00b3e2a8c928e9a4e896c3a211199444e96.zip"
    SHA512 2dd877121da2e21b6d1a339f66181c8a13b0e193e36ab2e1151906b824f78d18b5d261022900719ad0333a43f845fa4fcaecdb4b30ea7a2cc3356a631fd8493f
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libreplaygain_fixes.patch
#      001_libreplaygain_patch.patch
)

string(COMPARE EQUAL "${VCPKG_LIBRARY_LINKAGE}" "static" REPLAYGAIN-STATIC_BUILD_STATIC)
string(COMPARE EQUAL "${VCPKG_LIBRARY_LINKAGE}" "dynamic" REPLAYGAIN-SHARED_BUILD_SHARED)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libreplaygain RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libreplaygain)
