...
#git diff > ..\..\..\..\ports\librpc\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\librpc\001_librpc_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/twoporeguys/librpc/archive/0b1795b3d4f4e3a7d7b6c17e5725769d233a1e6f.zip"
    FILENAME "0b1795b3d4f4e3a7d7b6c17e5725769d233a1e6f.zip"
    SHA512 0a222987007b77ad39d3dcbbb6711fe4bebb1eae084572c793e8707ee80680306b174224e9e5117193e2de9a8c74319094cb118821acce8bf5111553562c05eb
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_librpc_fixes.patch
#      001_librpc_patch.patch
)
...
#      -D =OFF
    OPTIONS 
      ...
      -DBUILD_WS=OFF
      -DBUILD_XPC=ON
      -DBUNDLED_BLOCKS_RUNTIME=OFF
      -DENABLE_ASAN=OFF
      -DENABLE_COVERAGE=OFF
      -DENABLE_LIBDISPATCH=OFF
      -DENABLE_UBSAN=OFF
      -DENABLE_UBSAN_NULLABILITY=OFF
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/librpc RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME librpc)
