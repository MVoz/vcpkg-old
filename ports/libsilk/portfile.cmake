...
#git diff > ..\..\..\..\ports\libsilk\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\libsilk\001_libsilk_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/libsilk-1.0.8.tar.gz"
    FILENAME "libsilk-1.0.8.tar.gz"
    SHA512 cb98d57ac7abcac73969db22361a54205fd56fce70b92d54346a08897ce536e81979226532e5bd4d15354849c869be09b5766d1e8e9dd7cced1d1b88a1e98ba1
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_libsilk_fixes.patch
#      001_libsilk_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/libsilk-1.0.8.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/libsilk RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME libsilk)
