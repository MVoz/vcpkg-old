...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/RRZE-HPC/likwid/archive/winport.zip"
    FILENAME "likwid.zip"
    SHA512 6b5041c1f20a15ed26a739bd5387df32d2b52206b2d66dfab7206a5faadb1fdacd4c27faabc186de31e6e61e1f52876982fabd431aac3c82c5fa46629c86cf95
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
    PATCHES
#      001_likwid_fixes.patch
      001_likwid_patch.patch
)
...
vcpkg_install_msbuild(
    ...
    PROJECT_SUBPATH "build/vs/likwid.sln"
#    TARGET restore
    SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/likwid RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME likwid)
