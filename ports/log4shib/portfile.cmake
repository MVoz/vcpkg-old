...
#git diff > ..\..\..\..\ports\log4shib\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\log4shib\001_log4shib_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://shibboleth.net/downloads/log4shib/2.0.0/log4shib-2.0.0.zip"
    FILENAME "log4shib-2.0.0.zip"
    SHA512 beab6bdf3fefd51d075775b9e663bf1c0345044d98be826df2d10b3d60858c70369040c5c1d85b6129cad57fa12ca74014f563e0f2a90bf5a155c73fd457b962
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_log4shib_fixes.patch
#      001_log4shib_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://shibboleth.net/downloads/log4shib/2.0.0/log4shib-2.0.0.zip")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/log4shib RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME log4shib)
