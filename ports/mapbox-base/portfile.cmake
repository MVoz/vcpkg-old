...
#git diff > ..\..\..\..\ports\mapbox-base\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\mapbox-base\001_mapbox-base_patch.patch
...
set(GIT_URL "https://github.com/mapbox/mapbox-base")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/mapbox-base RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME mapbox-base)
