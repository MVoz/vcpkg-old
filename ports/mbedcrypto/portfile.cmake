...
#git diff > ..\..\..\..\ports\mbedcrypto\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\mbedcrypto\001_mbedcrypto_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/azadkuh/mbedcrypto/archive/a5473941b2e32c0535757547e42349ee2c7ca2b8.zip"
    FILENAME "a5473941b2e32c0535757547e42349ee2c7ca2b8.zip"
    SHA512 f745bd140b9132edfcedb66f6721c0fb0af81cb4f400a5bbd16b95be7af47803d07117f7d9e6a28ec3a9b1d552d06d36ac2db0eae97534ac9e26e56c611c9736
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_mbedcrypto_fixes.patch
#      001_mbedcrypto_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "https://github.com/timbaker/tippecanoe")
set(GIT_REV windows)
...
if(NOT EXISTS "${SOURCE_PATH}/.git")
    ...
    vcpkg_execute_required_process(
      COMMAND ${GIT} submodule update --recursive --remote ${SOURCE_PATH}
      WORKING_DIRECTORY ${SOURCE_PATH}
      LOGNAME submodules
    )
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/mbedcrypto RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME mbedcrypto)
