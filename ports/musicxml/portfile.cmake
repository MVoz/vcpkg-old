...
#git diff > ..\..\..\..\ports\musicxml\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\musicxml\001_musicxml_patch.patch
...
set(GIT_URL "https://github.com/venturemedia/mxml")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/musicxml RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME musicxml)
