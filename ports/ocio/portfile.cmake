...
vcpkg_configure_cmake(
    ...
    OPTIONS
        ${FEATURE_OPTIONS}
        -DOCIO_BUILD_SHARED=${_BUILD_SHARED}
        -DOCIO_BUILD_STATIC=${_BUILD_STATIC}
...
# Handle copyright
file(COPY ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/ocio)
file(RENAME ${CURRENT_PACKAGES_DIR}/share/ocio/LICENSE ${CURRENT_PACKAGES_DIR}/share/ocio/copyright)
