...
#git diff > ..\..\..\..\ports\opencv-bgsegm\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\opencv-bgsegm\001_opencv-bgsegm_patch.patch
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_opencv-bgsegm_fixes.patch
#      001_opencv-bgsegm_patch.patch
)
...
vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}/modules/bgsegm
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/opencv-bgsegm RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME opencv-bgsegm)
