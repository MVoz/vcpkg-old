...
#git diff > ..\..\..\..\ports\opencv-tracking\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\opencv-tracking\001_opencv-tracking_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/opencv/opencv_contrib/archive/4b6e4ef6637880fccbc35dc46657666129440af5.zip"
    FILENAME "4b6e4ef6637880fccbc35dc46657666129440af5.zip"
    SHA512 c849a4c4ecf6e0fc4d10a59ad9d273e6237d41a925da87308535d76bdc9af4f63ff9c26339f2ed574ec2d2404def495be01e4df08bcff0e343e31894f191603c
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_opencv-tracking_fixes.patch
#      001_opencv-tracking_patch.patch
)
...
vcpkg_configure_cmake(
    SOURCE_PATH ${SOURCE_PATH}/modules/tracking
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/opencv-tracking RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME opencv-tracking)
