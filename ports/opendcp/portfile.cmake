...
set(GIT_URL "https://github.com/tmeiczin/opendcp")
set(GIT_REV master)
...
#        ENABLE_DEBUG:BOOL=OFF
        -DENABLE_GUI=OFF # Qt4
        -DENABLE_OPENMP=ON
        -DENABLE_RAGNAROK=OFF
        -DENABLE_XMLSEC=OFF
        -DGENERATE_LANGUAGE_FILES=OFF
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/opendcp RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME opendcp)
