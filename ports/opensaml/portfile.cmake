...
#git diff > ..\..\..\..\ports\opensaml\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\opensaml\001_opensaml_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://shibboleth.net/downloads/c++-opensaml/3.0.1/opensaml-3.0.1.zip"
    FILENAME "opensaml-3.0.1.zip"
    SHA512 cc8ce6c2ca66283a1a1e2caa83e54a72afe395302b61f623b38b12b6a2085dc22ab524d4dbda6363ee0ca555e1eba94d13025b4f14f615245888bfa997406561
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_opensaml_fixes.patch
#      001_opensaml_patch.patch
)

vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "Projects/vc15/cpp-xmltooling.sln"
#    TARGET restore
    SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/opensaml RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME opensaml)
