...
set(GIT_URL "https://github.com/markjolah/ParallelRngManager")
set(GIT_REV master)
...
#      -D =OFF
    OPTIONS 
      ...
      -DBUILD_TESTING=OFF
      -DOPT_DOC=OFF
      -DOPT_INSTALL_TESTING=OFF
      -DOPT_EXPORT_BUILD_TREE=ON
      -DOPT_BLAS_INT64=ON
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/parallelrngmanager RENAME copyright)
