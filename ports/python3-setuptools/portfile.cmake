...
vcpkg_apply_patches(
    SOURCE_PATH ${CURRENT_INSTALLED_DIR}/debug/python3/Lib/site-packages/pip
...
vcpkg_apply_patches(
    SOURCE_PATH ${CURRENT_INSTALLED_DIR}/python3/Lib/site-packages/pip
    PATCHES ${CMAKE_CURRENT_LIST_DIR}/fix-pip-install.patch
)
...
file(COPY ${CMAKE_CURRENT_LIST_DIR}/python-pip-install.cmake
     ...
     DESTINATION ${CURRENT_PACKAGES_DIR}/share/python3-setuptools)
