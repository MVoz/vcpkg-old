...
#git diff > ..\..\..\..\ports\raptor\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\raptor\001_raptor_patch.patch
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_raptor_fixes.patch
#      001_raptor_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://download.librdf.org/source/raptor2-2.0.15.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/raptor RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME raptor)
