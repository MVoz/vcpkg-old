...
#git diff > ..\..\..\..\ports\rinchi\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\rinchi\001_rinchi_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.inchi-trust.org/download/RInChI/RInChI-V1-00.zip"
    FILENAME "RInChI-V1-00.zip"
    SHA512 8389e0e1804c47f139eabbbeddaf32e158e647a964d5d456fc0b1f1703d41037481cc470c88eb52b5857c609a296f60c781b69085c37eee3d2bc8a0dc60435a8
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_rinchi_fixes.patch
#      001_rinchi_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.inchi-trust.org/download/RInChI/RInChI-V1-00.zip")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/rinchi RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME rinchi)
