...
#git diff > ..\..\..\..\ports\shibboleth\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\shibboleth\001_shibboleth_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://shibboleth.net/downloads/service-provider/3.0.4/shibboleth-sp-3.0.4.zip"
    FILENAME "shibboleth-sp-3.0.4.zip"
    SHA512 d51b8f7178f5f880553f952050ae6d7e7e952056026267bd5387adc78021e6c25ef4f931f885104deb36c5ad63510e3306aaed9aa6be276dcf7a79e4b00ec7ed
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_shibboleth_fixes.patch
#      001_shibboleth_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://shibboleth.net/downloads/service-provider/3.0.4/shibboleth-sp-3.0.4.zip")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/shibboleth RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME shibboleth)
