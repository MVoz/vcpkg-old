...
#git diff > ..\..\..\..\ports\sofia-sip\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\sofia-sip\001_sofia-sip_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/sofia-sip-1.12.11.tar.gz"
    FILENAME "sofia-sip-1.12.11.tar.gz"
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_sofia-sip_fixes.patch
#      001_sofia-sip_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/sofia-sip-1.12.11.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/sofia-sip RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME sofia-sip)
