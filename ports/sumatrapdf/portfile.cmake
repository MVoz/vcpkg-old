...
#git diff > ..\..\..\..\ports\sumatrapdf\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\sumatrapdf\001_sumatrapdf_patch.patch
...
set(GIT_URL "https://github.com/sumatrapdfreader/sumatrapdf")
set(GIT_REV master)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "vs2017/SumatraPDF.sln"
    TARGET restore
    SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/sumatrapdf RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME sumatrapdf)
