...
vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/tcltk/thread/archive/2a755391395df8531e28b759e038f0953a775b2b.zip"
    FILENAME "2a755391395df8531e28b759e038f0953a775b2b.zip"
    SHA512 2b5b95c314fda1c8abae5da9e67005a37c0bc69c446b8876222d18b07662b53b74bde6e7662eeb291cf434c74d9c996ae59cbdebd70ce0d13b872b2af7c3e703
)
...
vcpkg_configure_make(
	...
	OPTIONS
		"TCLDIR=${CURRENT_BUILDTREES_DIR}/tcl8"
    OPTIONS_RELEASE
        "INSTALLDIR=${CURRENT_PACKAGES_DIR}" "OPTS=release"
    OPTIONS_DEBUG
	    "INSTALLDIR=${CURRENT_PACKAGES_DIR}/debug" "OPTS=debug"
	POSTRUN_SHELL_RELEASE
	    "INSTALLDIR=${CURRENT_PACKAGES_DIR}" "install"
	POSTRUN_SHELL_DEBUG 
	    "INSTALLDIR=${CURRENT_PACKAGES_DIR}/debug" "install"
)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/thread RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME thread)
