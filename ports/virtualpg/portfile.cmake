...
#git diff > ..\..\..\..\ports\virtualpg\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\virtualpg\001_virtualpg_patch.patch
...
vcpkg_download_distfile(ARCHIVE
    URLS "http://www.gaia-gis.it/gaia-sins/virtualpg-sources/virtualpg-2.0.0-RC0.tar.gz"
    FILENAME "virtualpg-2.0.0-RC0.tar.gz"
    SHA512 1a503eae569f7809e649be5522b6f7608e45a28fac0bc8ecf1614190c50dc915b122808f4fd551e92cdd6aab6c3bc65825e320d679ba9cac89ac03c29ac70065
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_virtualpg_fixes.patch
#      001_virtualpg_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://www.gaia-gis.it/gaia-sins/virtualpg-sources/virtualpg-2.0.0-RC0.tar.gz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/virtualpg RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME virtualpg)
