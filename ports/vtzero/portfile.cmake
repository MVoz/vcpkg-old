...
#git diff > ..\..\..\..\ports\vtzero\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\vtzero\001_vtzero_patch.patch
...
set(GIT_URL "https://github.com/mapbox/vtzero")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/vtzero RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME vtzero)
