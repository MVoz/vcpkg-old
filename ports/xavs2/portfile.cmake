...
#git diff > ..\..\..\..\ports\xavs2\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\xavs2\001_xavs2_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "https://github.com/pkuvcl/xavs2/archive/eae1e8b9d12468059bdd7dee893508e470fa83d8.zip"
    FILENAME "eae1e8b9d12468059bdd7dee893508e470fa83d8.zip"
    SHA512 6457f3ec284b29b1a6f91597d8fef9ca0207c3d77a3752b49b6234497437943e380b55e0057d8807f99dcabe8d939041264144e0d0abe2bd373428376874054b
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_xavs2_fixes.patch
#      001_xavs2_patch.patch
)
...
vcpkg_install_msbuild(
    SOURCE_PATH ${SOURCE_PATH}
    PROJECT_SUBPATH "build/vs2013/xavs2.sln"
	SKIP_CLEAN
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/xavs2 RENAME copyright)
