...
#git diff > ..\..\..\..\ports\xmlrpc-c\patch.patch

#git init . && git add . && git commit -m "patch"
#git diff > ..\..\..\..\ports\xmlrpc-c\001_xmlrpc-c_patch.patch

include(vcpkg_common_functions)

vcpkg_download_distfile(ARCHIVE
    URLS "http://files.freeswitch.org/downloads/libs/xmlrpc-c-1.03.14.tgz"
    FILENAME "xmlrpc-c-1.03.14.tgz"
    SHA512 c2b935742f6c76ed0813cb47bda7a834aa85333f8631a069b6caf6e95a6831a73241457807be0a9401ea18042ea5f14b574cb0b3369b30e8291ff708a2d1fa1a
)
...
vcpkg_extract_source_archive_ex(
    ...
    ARCHIVE ${ARCHIVE}
#    PATCHES
#      001_xmlrpc-c_fixes.patch
#      001_xmlrpc-c_patch.patch
)

find_program(GIT NAMES git git.cmd)
set(GIT_URL "http://files.freeswitch.org/downloads/libs/xmlrpc-c-1.03.14.tgz")
set(GIT_REV master)
...
#file(INSTALL ${SOURCE_PATH}/LICENSE DESTINATION ${CURRENT_PACKAGES_DIR}/share/xmlrpc-c RENAME copyright)
...
# vcpkg_test_cmake(PACKAGE_NAME xmlrpc-c)
