...
function(vcpkg_configure_cmake)
    ...
    if(VCPKG_LIBRARY_LINKAGE STREQUAL "dynamic")
        list(APPEND _csc_OPTIONS -DLIBRARY_TYPE=shared -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DBUILD_BOTH_STATIC_SHARED_LIB=ON)
    elseif(VCPKG_LIBRARY_LINKAGE STREQUAL "static")
        list(APPEND _csc_OPTIONS -DBUILD_SHARED_LIBS=OFF -DLIBRARY_TYPE=static -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DBUILD_BOTH_STATIC_SHARED_LIB=ON)
    else()
