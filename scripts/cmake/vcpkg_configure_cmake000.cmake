...
#        -G"Visual Studio 15 2017" -T"Intel C++ Compiler 19.0",host=x64 -Ax64
    ...
    if(NOT VCPKG_CHAINLOAD_TOOLCHAIN_FILE)
        ...
        elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "MSYS")
            list(APPEND _csc_OPTIONS "-DVCPKG_CHAINLOAD_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/toolchains/msys64.cmake")
        elseif(VCPKG_CMAKE_SYSTEM_NAME STREQUAL "MipsEL")
            list(APPEND _csc_OPTIONS "-DVCPKG_CHAINLOAD_TOOLCHAIN_FILE=${VCPKG_ROOT_DIR}/scripts/toolchains/mips32r2.cmake")
        endif()
    endif()
